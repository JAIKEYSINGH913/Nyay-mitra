...
export default function Footer() {
  return (
    <footer className="bg-[#0e0e0e] py-20 px-6 border-t border-border-color">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        {/* Brand Column */}
        <div className="col-span-1 md:col-span-2">
          <Link href="/" className="flex flex-col mb-8">
            <span className="font-space text-2xl font-black tracking-tighter text-[#e5e2e1] uppercase leading-none">
              NYAYMITRA_OS
            </span>
            <span className="telemetry-label !text-[8px] opacity-40 mt-1">SOVEREIGN_JUDICIAL_ENVIRONMENT</span>
          </Link>
          <p className="text-[#e7bdb8] opacity-60 text-sm leading-relaxed max-w-sm mb-10">
          ...
          <div className="flex gap-4">
            {[
              ...
              <motion.div
                key={i}
                className="w-10 h-10 bg-[#2a2a2a] border border-border-color flex items-center justify-center hover:bg-primary-container hover:text-white transition-all cursor-pointer"
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-border-color flex flex-col md:flex-row justify-between items-center gap-6">
        <span className="telemetry-label !text-[10px] opacity-40">© 2026 NYAYMITRA_OS. ALL_RIGHTS_RESERVED.</span>
